    ...
    <header class="bg-white">
        <div class="container mx-auto px-4 py-8 flex items-center">
            ...
            <div class="mr-auto md:w-48 flex-shrink-0">
                <img class="inline h-32" src="./../assets/notion.png" alt="" />
            </div>
            ...
            >
                <span class="font-bold md:text-xl">REMIND YOURSELF</span>
                <span class="font-semibold text-sm text-gray-400"
                    >Create notes and share it!</span
                >
            </div>
                ...
                <ul class="ml-4 xl:w-48 flex items-center justify-end">
                    <li class="ml-2 lg:ml-4 relative inline-block">
                        <a class="" href="">
                            ...
                            <svg
                                class="h-9 lg:h-10 p-2 text-gray-500 svg-inline--fa fa-heart fa-w-16 fa-9x"
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="far"
                                data-icon="heart"
                    ...
                    <li class="ml-2 lg:ml-4 relative inline-block">
                        <a class="" href="">
                            ...
                            <svg
                                class="h-9 lg:h-10 p-2 text-gray-500 svg-inline--fa fa-shopping-cart fa-w-18 fa-9x"
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="far"
            ...
            <div class="ml-4 hidden sm:flex flex-col font-bold">
                <span class="text-xs text-gray-400">Logout</span>
                <span>NAME</span>
            </div>
        </div>
